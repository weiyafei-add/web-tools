...
exports.exactToPrecision = exports.accSub = exports.accMul = exports.accDiv = exports.accAdd = void 0;
...
var exactToPrecision = function (num, precision) {
    if (precision === void 0) { precision = 2; }
    return accDiv(parseInt("".concat(accMul(num, Math.pow(10, precision)))), Math.pow(10, precision)).toFixed(precision);
};
exports.exactToPrecision = exactToPrecision;

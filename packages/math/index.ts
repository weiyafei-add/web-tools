...
var accAdd: normalFunction = function (num1, num2) {
  num1 = Number(num1);
  num2 = Number(num2);
  var dec1, dec2, times;
  try {
...
var accSub: normalFunction = function (num1, num2) {
  num1 = Number(num1);
  num2 = Number(num2);
  var dec1, dec2, times;
  try {
...
var accDiv: normalFunction = function (num1, num2) {
  num1 = Number(num1);
  num2 = Number(num2);
  var t1 = 0,
    t2 = 0,
...
var accMul: normalFunction = function (num1, num2) {
  num1 = Number(num1);
  num2 = Number(num2);
  var times = 0,
    s1 = num1.toString(),
...
var countDecimals: normalFunction = function (num) {
  var len = 0;
  try {
    num = Number(num);
...
var convertToInt: normalFunction = function (num) {
  num = Number(num);
  var newNum = num;
...
var getCorrectResult: getCorrectResultType = function (type, num1, num2, result) {
  var temp_result = 0;
  switch (type) {
    case "add":
...
const exactToPrecision = (num: number, precision = 2) => {
  return accDiv(parseInt(`${accMul(num, Math.pow(10, precision))}`), Math.pow(10, precision)).toFixed(precision);
};
